...
public class ArraysUtility {
    ...
    public static char[] merge(char[] arr1, char[] arr2) {
        ...
        char k = 0; // for third array's index number
        for (char i = 0; i < arr1.length; i++, k++) { // i: for second array's index numbers
            arr3[k] = arr1[i];

        }

        for (char i = 0; i < arr2.length; i++, k++) { // i: for first array's index numbers
            arr3[k] = arr2[i];
    ...
    public static String[] merge(String[] arr1, String[] arr2) {
        ...
        int k = 0; // for third array's index number
        for (int i = 0; i < arr1.length; i++, k++) { // i: for second array's index numbers
            arr3[k] = arr1[i];
